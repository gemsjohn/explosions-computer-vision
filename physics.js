...
const fixedTimeStep = 1 / 30; // 30 Hz
...
export function updatePhysics(delta, keys, eventQueue) {
    ...
    while (accumulatedTime >= fixedTimeStep) {
        // Physics calculations here (velocity, angular velocity, etc.)
        world.step(eventQueue, { numSubsteps: 2 });
    ...
    world.step(eventQueue, { numSubsteps: 4 });
